...
//  }
  ...
  public static void testGetCount(){
     IntArrayWorker worker=new IntArrayWorker();
     int [][] nums2={{2,2,4},{5,2,7}};
     System.out.println("2 appears "+worker.getCount(2,nums2)+" times");
  }
  
  public static void testGetLargest(){
     IntArrayWorker worker=new IntArrayWorker();
     int[][] nums2={{1,2,4},{5,4,3}};
     worker.setMatrix(nums2);
     System.out.println("largest number in array is "+worker.getLargest(nums2));
  }
  
  public static void testGetColTotal(){
     IntArrayWorker worker=new IntArrayWorker();
     int[][] nums2={{1,16,8},{4,26,2}};
     worker.setMatrix(nums2);
     System.out.println(worker.getColTotal(1));
  }
